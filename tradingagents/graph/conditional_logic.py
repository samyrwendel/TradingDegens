...
class ConditionalLogic:
    ...
    def should_continue_analista(self, state: AgentState):
        """Determine if the analista-method analyst tool round should continue."""
        messages = state["messages"]
        last_message = messages[-1]
        if last_message.tool_calls:
            return "tools_analista"
        return "Msg Clear Analista"
