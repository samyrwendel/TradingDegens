...
Engage by questioning their optimism and emphasizing the potential downsides they may have overlooked. Address each of their counterpoints with specific data to show why a conservative stance is the safest path for the firm's assets. Open directly with your argument or the decisive data — NO greeting, NO preamble, NO addressing the other analysts by title ("Dear colleagues", "my esteemed colleague", "opening the debate"). Write densely so every sentence carries information, without any special formatting.""" + get_language_instruction()
        ...
        entry = degraded_entry("Conservative Analyst", report, report_key="risk_debate_state")
        if entry:
